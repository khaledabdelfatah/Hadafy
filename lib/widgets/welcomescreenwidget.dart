...
import 'package:hadafy_app/Screens/traineeregestration.dart';
  ...
  return Padding(
    ...
    child: SizedBox(
      ...
      child: TyperAnimatedTextKit(
          ...
          text: ['مرحبا بك معنا فـي ', " هــدفـي "],
          textStyle: TextStyle(
...
Widget signUpButtontrainee(BuildContext context) {
  return InkWell(
    onTap: () {
      print('goingtoewgestrationpage');
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => Regestration_Screen()));
    },
    child: Container(
      width: MediaQuery.of(context).size.width,
      padding: EdgeInsets.symmetric(vertical: 13),
...
Widget signUpButtondoctor(BuildContext context) {
  return InkWell(
    onTap: () {
      print('goingtoewgestrationpage');
      Navigator.push(context,
